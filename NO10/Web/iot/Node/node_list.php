...
$query_Recordset1 = "SELECT * ,Site.s_name as cusname , DeviceType.s_name as tyepname FROM `Node`, Site, DeviceType  WHERE Node.site_id = Site.s_id and Node.s_type = DeviceType.s_id  ";
//$query_Recordset1 = "SELECT * FROM Node  ORDER BY site_id ASC";
...
<form id="form1" name="form1" method="post" action="">
  <table width="100%" border="1">
    ...
    <?php do { ?>
  <tr>
    <td><?php echo $row_Recordset1['s_id']; ?></td>
    <td><?php echo $row_Recordset1['cusname']; ?></td>
    <td><?php echo $row_Recordset1['s_mac']; ?></td>
    <td><?php echo $row_Recordset1['tyepname']; ?></td>
    <td><?php echo $row_Recordset1['s_type']; ?></td>
    <td><?php echo $row_Recordset1['s_used']; ?></td>
    <td><a href="node_add.php">新增</a> /修改' /刪除</td>
  </tr>
