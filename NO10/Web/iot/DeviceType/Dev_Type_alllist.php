...
mysql_select_db($database_connect, $connect);
$query_Recordset1 = sprintf("SELECT * FROM Node WHERE s_type = %s ORDER BY site_id ASC", GetSQLValueString($colname_Recordset1, "int"));
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $connect) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
<form id="form1" name="form1" method="post" action="">
  ...
  <tr>
    ...
    <td><?php echo $row_Recordset1['site_id']; ?></td>
  ...
  <p><a href="Dev_Type_index.php" target="_self">回上頁</a></p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
</form>
